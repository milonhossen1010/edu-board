               ...
               <section class="vbox">
                    <section class="scrollable padder">
                         ...
                         <section class="row m-b-md">
                              <div class="col-sm-6">
                                   <h3 class="m-b-xs text-black">All Students</h3> <small>Welcome back, <?php echo $_SESSION['name']; ?> <i class="fa fa-envelope fa-lg text-primary"></i> <?php echo $_SESSION['email']; ?></small>
                              </div>
